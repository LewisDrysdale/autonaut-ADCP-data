...
sgtitle([name ' correlation']) ;
print(gcf,'-dpng',['figures/' name '_correlation']);
...
n = 3600;             % Number of elements to create the mean over
% hourly mean of U
...
q1 = quiver(X,Y,U,V,'AutoScale','off', 'AutoScaleFactor',3,'LineWidth',0.1,...
    'Color','k');
hold on
q2 = quiver(Lon_avg,Lat_avg,u_avg,v_avg,'AutoScale','off', 'AutoScaleFactor',3,'LineWidth',1.5,...
    'Color','r');
axis equal

legend([q1 q2],'Sample','Hourly average');
title([name]) 
